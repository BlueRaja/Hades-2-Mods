...
local function enableCharonGoldDrops()
    ...
    for unitName, unitData in pairs(UnitSetData) do
        if unitData.MoneyDropOnDeath and unitData.MoneyDropOnDeath.Chance then
            if unitData.MoneyDropOnDeath.Chance == 0.0 then
                ...
                unitData.MoneyDropOnDeath.Chance = 0.2
                ...
                unitData.MoneyDropOnDeath.Chance = math.min(unitData.MoneyDropOnDeath.Chance + 0.2, 1.0)
            end
        end
    end
end
