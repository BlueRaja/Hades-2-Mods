-- Check if any of these incantations are enabled
if not (Config.IncantationsEnabled.Artemis or Config.IncantationsEnabled.Icarus or Config.IncantationsEnabled.Athena) then
    return
end
...
-- Artemis Incantation
if Config.IncantationsEnabled.Artemis then
...
-- Icarus Incantation
if Config.IncantationsEnabled.Icarus then
    Incantations.addIncantation({
...
-- Athena Incantation
if Config.IncantationsEnabled.Athena then
    Incantations.addIncantation({
