...
Incantations.addIncantation({
    ...
    Description = {
        en = "Increases the {#Emph}number of {!Icons.TalentDrop} {#Prev}you get from Path of Stars boons by 1",
        de = "Erhöht die {#Emph}Anzahl der {!Icons.TalentDrop} {#Prev}, die du von Path of Stars-Segen erhältst, um 1",
        el = "Αυξάνει τον {#Emph}αριθμό των {!Icons.TalentDrop} {#Prev}που παίρνεις από τα Path of Stars ευλογία κατά 1",
        es = "Aumenta el {#Emph}número de {!Icons.TalentDrop} {#Prev}que obtienes de las bendiciones del Sendero de las Estrellas en 1",
        fr = "Augmente le {#Emph}nombre de {!Icons.TalentDrop} {#Prev}que vous obtenez des bénédictions du Chemin des Étoiles de 1",
        it = "Aumenta il {#Emph}numero di {!Icons.TalentDrop} {#Prev}che ottieni dalle benedizioni del Sentiero delle Stelle di 1",
        ja = "星の道の恩恵から得られる{#Emph}{!Icons.TalentDrop}の数{#Prev}を1増加させる",
        ko = "별의 길 축복에서 얻는 {#Emph}{!Icons.TalentDrop}의 수{#Prev}를 1개 증가시킨다",
        pl = "Zwiększa {#Emph}liczbę {!Icons.TalentDrop} {#Prev}które otrzymujesz z błogosławieństw Ścieżki Gwiazd o 1",
        ["pt-BR"] = "Aumenta o {#Emph}número de {!Icons.TalentDrop} {#Prev}que você obtém das bênçãos do Caminho das Estrelas em 1",
        ru = "Увеличивает {#Emph}количество {!Icons.TalentDrop} {#Prev}, которые вы получаете от благословений Пути Звёзд, на 1",
        tr = "Yıldızlar Yolu nimetlerinden aldığın {#Emph}{!Icons.TalentDrop} sayısını{#Prev} 1 artırır",
        uk = "Збільшує {#Emph}кількість {!Icons.TalentDrop} {#Prev}, які ви отримуєте від благословень Шляху Зірок на 1",
        ["zh-CN"] = "增加从星路恩惠中获得的{#Emph}{!Icons.TalentDrop}数量{#Prev}1个",
        ["zh-TW"] = "增加從星路恩惠中獲得的{#Emph}{!Icons.TalentDrop}數量{#Prev}1個",
    },
    FlavorText = {
